...
<body class="bg-light">
    <header class="fixed-top">
                ...
                <div class="row">
                    <div class="col-sm-12 col-md-12 py-2">
                        ...
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item bg-secondary text-white px-0 py-3 d-flex align-item-center justify-content-between">
                                <div>
                                    <a href="?page=filemanager" class="text-decoration-none text-white">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="me-2" viewBox="0 0 16 16">
        ...
        <div class="navbar navbar-dark bg-white shadow-sm">
            <div class="container">
                <a href="index.php" class="navbar-brand d-flex align-items-center text-dark">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-asterisk me-2" viewBox="0 0 16 16">
